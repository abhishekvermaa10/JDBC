<h1 align="center">Java Database Connectivity (JDBC)</h1>

<p align="justify">
    Welcome to the <b>Java Database Connectivity (JDBC)</b> repository! This repository provides hands-on demos,
    starting from establishing a database connection to performing CRUD operations using <b>Statement</b>,
    <b>PreparedStatement</b>, and <b>CallableStatement</b>. It also covers essential topics like transaction management
    and code optimization techniques to help you write efficient and maintainable JDBC applications.
</p>
...
<ol>
    <li>CRUD using List</li>
    <li>Establish connection with Database</li>
    <li>CRUD using Statement</li>
    <li>CRUD using PreparedStatement</li>
    <li>Call using CallableStatement</li>
    <li>Transactions</li>
    <li>Tips to enhance code</li>
</ol>
...
<p align="justify">
    ...
    Watch the complete playlist here: <a href="https://www.youtube.com/playlist?list=PLJDwhlqmpSfP1FroiBGc7N3-r67VaEp0V"
        target="_blank"><b>Java Database Connectivity (JDBC)</b></a>.
</p>
